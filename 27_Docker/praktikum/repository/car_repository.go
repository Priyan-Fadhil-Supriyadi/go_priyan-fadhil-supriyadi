...
func (r *carRepositoryMysqlLayer) GetOneCarByID(id int) (car model.Car, err error) {
...
func (r *carRepositoryMysqlLayer) UpdateOneCarByID(id int, car model.Car) error {
...
func (r *carRepositoryMysqlLayer) DeleteCarByID(id int) error {
